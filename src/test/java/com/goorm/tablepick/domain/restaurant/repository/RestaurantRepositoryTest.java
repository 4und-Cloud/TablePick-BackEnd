...
public class RestaurantRepositoryTest {
    ...
    void searchAllByKeywordAndTags() {
        ...
        Page<Restaurant> restaurants = restaurantRepository.findAllByKeywordAndTags("식당", tagIds, tagIds.size(),
                pageable);
    ...
    void searchByKeywordUsingQueryDSL() {
        ...
        Page<RestaurantSearchResponseDto> restaurants = restaurantRepository.searchRestaurantResult("식당", tagIds,
                pageable);
