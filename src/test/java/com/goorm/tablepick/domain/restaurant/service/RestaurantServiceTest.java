...
//
//        // when & then
//        Assertions.assertThatThrownBy(() -> restaurantService.searchRestaurants(requestDto))
...
//        BoardTag boardTag7 = BoardTag.builder().tag(tag3).restaurant(restaurant3).board(board3).build();
//
...
//
//    @Test
//    @DisplayName("4개 이상의 키워드를 선택해 검색하면 예외가 발생한다.")
...
//    }
//
//    @DisplayName("검색어와 태그 없이 검색시 예약이 많은 순으로 식당을 찾는다.")
//    @Test
...
//        PagedRestaurantResponseDto restaurants = restaurantService.searchRestaurants(requestDto);
//
//        // then
//        Assertions.assertThat(restaurants.getRestaurants()).hasSize(3)
//                .extracting("name")
//                .containsExactlyElementsOf(List.of("달콤한 카페", "골목 식당", "바다 식당"));
//    }
//
//
